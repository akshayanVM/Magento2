...
class TopCategoriesWidget implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $cmsBlockData = [
            'title' => 'Top Categories Block',
            'identifier' => 'Top Categories Widget Block',
