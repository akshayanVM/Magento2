    ...
    public function templateFallbackDataProvider()
    {
        return [
            ...
            'Template from theme - frontend' => [
                Area::AREA_FRONTEND,
                'customer_create_account_email_template',
                'customer_create_account_email_template template from Egits/custom_theme',
                Area::AREA_FRONTEND,
            ],
            'Template from parent theme - frontend' => [
                Area::AREA_FRONTEND,
                'customer_create_account_email_confirmation_template',
                'customer_create_account_email_confirmation_template template from Egits/default',
                Area::AREA_FRONTEND,
            ],
    ...
    public function templateDirectiveDataProvider()
    {
        return [
            ...
            'Template from theme - frontend' => [
                ...
                '<strong>customer_create_account_email_template template from Egits/custom_theme</strong>',
            ],
            'Template from parent theme - frontend' => [
                Area::AREA_FRONTEND,
                TemplateTypesInterface::TYPE_HTML,
                '{{template config_path="customer/create_account/email_confirmation_template"}}',
                '<strong>customer_create_account_email_confirmation_template template from Egits/default</strong',
            ],
            'Template from grandparent theme - frontend' => [
                Area::AREA_FRONTEND,
                TemplateTypesInterface::TYPE_HTML,
